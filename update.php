...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $statement = $pdo->prepare("UPDATE customersdetails SET name = :name, address = :address, city = :city, pin_code = :pin_code, country = :country, description = :description WHERE id = :id");
            ...
            $statement->bindValue(':id', $id);
            $statement->execute();
            $successes[] = "Details Has Been Successfully Updated.";
